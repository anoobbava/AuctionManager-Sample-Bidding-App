...
ActiveRecord::Schema.define(version: 20170329215429) do
  ...
  create_table "balls", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "over_id"
  ...
  create_table "bid_logs", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "amount"
    t.bigint "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "innings", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "team_id"
    t.integer "match_id"
    t.integer "runs_scored"
  ...
  create_table "overs", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "bowler_id"
    t.integer "inning_id"
  ...
  create_table "wickets", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "batsman_id"
    t.integer "bowler_id"
    t.integer "ball_id"
    t.integer "inning_id"
